...
export default function DashboardPage(): React.ReactElement | null {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Mobile button for adding tournament */}
      <div className="lg:hidden flex justify-center px-4 py-4">
        <button
          onClick={() => router.push('/dashboard/add-tournament')}
          className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700"
        >
          Add Tournament
        </button>
      </div>
      {/* For desktop, add the button in the top right */}
